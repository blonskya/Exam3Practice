...
def run_test_zero_changer():
    ...
    test2 = ([0, 4, 0, 9], [77, 0, 23, 0, 2, 4], [0, 0, 0], [1, 2, 3])
    expected2 = ([1, 4, 2, 9], [77, 3, 23, 4, 2, 4], [5, 6, 7], [1, 2, 3])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    test3 = ([1, 4, 2, 9], [3], [5, 6, 7], [])
    expected3 = ([1, 4, 2, 9], [3], [5, 6, 7], [])
    zero_changer(test3)
    print()
    print('Test 3:')
